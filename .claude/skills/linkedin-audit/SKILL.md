...
Write to `search/vault/generated/linkedin-audit/linkedin-audit-{YYYY-MM-DD}.md`:
...
```
write_to_blackboard path="events.{spawn_id}" value={"event":"agent_complete","spawn_id":"{spawn_id}","agent":"networking","skill":"linkedin-audit","output_path":"search/vault/generated/linkedin-audit/linkedin-audit-{date}.md","status":"completed"} log_entry="linkedin-audit spawn complete"
```
