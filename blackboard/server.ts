...
function ensureSearchStructure(): void {
  ...
  const files: Record<string, string> = {
    ...
    'context/career-plan.yaml': YAML.stringify({ goals: [] }),
    'context/target-companies.yaml': YAML.stringify({ companies: [] }),
    'context/resume-master.yaml': YAML.stringify({ sections: [] }),
    'context/preferences.yaml': YAML.stringify({ preferences: {} }),
    'context/network.yaml': YAML.stringify({ contacts: [] }),
